...
[👉 Register for Fintopio](https://fintop.io/2wY1qbqjYk)
...
3. **Set up your accounts**
   ...
   Rename `accounts_example.json` into `accounts.json`
   Then edit `accounts.json`. Add your Fintopio account data, one per line, in the following format:
...
- Keep your `accounts.json` file secure and never share it with others.
